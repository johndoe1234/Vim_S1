...
if  s:MSWIN
  " ==========  MS Windows  ======================================================
	...
	"
	let s:Perl_LocalTemplateFile		= 'd:\Vim_S1\perl-support\templates\Templates'
	let s:Perl_LocalTemplateDir			= fnamemodify( s:Perl_LocalTemplateFile, ":p:h" ).'/'
	let s:Perl_CodeSnippets  				= 'd:\Vim_S1\vimfiles\perl-support\codesnippets\'
  let s:escfilename 	  					= ''
	let s:Perl_Display  						= ''
	"
else
